        ...
        if data_type == selected_data_type:
            ...
            if data_type == "Origination Data":
                ...
                try:
                    ...
                    #variables
                    path_to_repo_dir="C:/Users/91730/Documents/GitHub/Assignment1"
                    ...
                    datasource_name = "Local_FileSystem_Source4"
                    ...
                    validator.expect_column_values_to_be_in_set(column="FIRST TIME HOMEBUYER FLAG", value_set=['Y'])
                    ...
                    checkpoint_result = checkpoint.run(run_name="Manual Run for Origination Data 2")
